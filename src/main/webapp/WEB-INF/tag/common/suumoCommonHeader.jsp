                            ...
                            <div class="mylistbar">
                                ...
                                <ul class="mylistbar-inbar">
                                    <li class="mylistbar-inbar-item">
                                        <a
                                        href="/jj/common/service/JJ901FM203/?ar=020&amp;bs=040&amp;cts=01"
                                    ...
                                    <li class="mylistbar-inbar-item">
                                        <a
                                        href="/jj/common/service/JJ901FM203/?ar=020&amp;bs=040&amp;cts=02"
...
-->
    ...
    <div class="siteheadercontainer">
        <div class="siteheader">
            <div class="desc">
                <p class="desc-title">${descTitle }</p>
            </div>
            <div class="siteheader-inner">
                <div class="logo">
                    <div class="logo-object">
                        <a href="/"><img src="/img/sprite/logo.png"
                    ...
                    <div class="logo-field">
                        ...
                        <div class="logo-field-area">${areaName }版</div>
                    </div>
                </div>
                <div class="gnav">
                    <ul class="gnav_list">
                            ...
                            <dl class="gnav_item gnav_item--chintai">
                                ...
                                <dd class="gnav_item-definition">
                                    <div
                                        ...
                                        <a href="/chintai/"
                                            class="gnav_btn gnav_btn--chintai is-active"
                                            title="賃貸">賃貸</a>
                                    </div>
                                </dd>
                            </dl>
