    ...
    <div id="js-contents-mainPanel" class="contents">
        ...
        <div id="js-contents-mainPanel" class="contents">
                ...
                <div class="ui-section-body">
                    ...
                    <form name="chintai_kensaku_FR301FB004ActionForm"
                        ...
                        <div id="js-gotoEkiErrorPanel"
                            class="error_pop dn" style="display: none;">
            ...
            <form id="js-shiborikomiPanel-searchBtnForm"
                action="/jj/chintai/ichiran/FR301FC001/?ar=${hissu.ar }&amp;bs=${hissu.bs }&amp;ra=${hissu.ra }"></form>
            <form name="chintai_kensaku_FR301FB004ActionForm"
                id="js-shiborikomiForm" method="post"
                action="/jj/chintai/kensaku/FR301FB004/">
                <div class="ui-section--h2 item">
                    <!-- FR301FK0040_01 START -->
                    <span rel="" id="js-sdFlg"></span> <input
                        type="hidden" id="js-sdParam" value="1"
                        name="sd" disabled="disabled">
                    <div class="ui-section-header">
                        <h2>その他条件を指定</h2>
                    </div>
                    <div class="ui-section-body">
                        ...
                        <div class="l-refinetable">
                            <table
                                class="ui-table--itemcol4 refinetable">
                                <tbody>
                                    <tr>
                                        <th>賃料</th>
                                        <td>
                                            <div class="selectunit">
                                                <select name="cb"><option
                                                    ...
                                                    <option
                                                        value="100.0">100万円以上</option></select><span
                                                    ...
                                                    <option
                                                        value="100.0">100万円以下</option></select>
                                                <div
