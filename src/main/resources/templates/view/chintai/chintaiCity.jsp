...
<body>
    <div id="js-contents-mainPanel" class="contents">
        <span id="js-areatabOnClickUrl"
            rel="/jj/chintai/kensaku/FR301FB001/?ar=${area}&amp;bs=040"></span>
        <ul id="js-areatabPanel"
            class="ui-tab--base ui-tab--base03 areatab">
            <li><a href="/chintai/fukuoka/city/"
                class="ui-tab-item js-areatabClickLink" rel="ta=40">福岡県</a></li>
            <li><a href="/chintai/saga/city/"
                class="ui-tab-item js-areatabClickLink" rel="ta=41">佐賀県</a></li>
            <li><a href="/chintai/nagasaki/city/"
                class="ui-tab-item js-areatabClickLink" rel="ta=42">長崎県</a></li>
            <li><a href="/chintai/kumamoto/city/"
                class="ui-tab-item js-areatabClickLink" rel="ta=43">熊本県</a></li>
            <li><a href="/chintai/oita/city/"
                class="ui-tab-item js-areatabClickLink" rel="ta=44">大分県</a></li>
            <li><a href="/chintai/miyazaki/city/"
                class="ui-tab-item js-areatabClickLink" rel="ta=45">宮崎県</a></li>
            <li><a href="/chintai/kagoshima/city/"
                class="ui-tab-item js-areatabClickLink" rel="ta=46">鹿児島県</a></li>
            <li><a class="ui-tab-item is-active">沖縄県</a></li>
        </ul>
                ...
                <div class="ui-section-body">
                    <div class="selectareatitle">
                        <span
                            ...
                            class="selectareatitle-b">市区郡にチェック</span>をいれてください（複数選択できます）
                    </div>
                    <form name="chintai_kensaku_FR301FB001ActionForm"
                        id="js-areaSelectForm" method="post"
                        action="/jj/chintai/kensaku/FR301FB001/">
                        <input type="hidden" name="ar" value="090"><input
                            type="hidden" name="bs" value="040"><input
                            type="hidden" name="ta" value="47">
                        <div id="js-gotoEkiErrorPanel"
                            class="error_pop dn">
                        ...
                        <div class="l-searchtable">
                            <table class="searchtable">
                                <tbody>
                                    <tr>
                                        <th class="searchtable-title">沖縄県</th>
                                            ...
                                            <div class="searchitem">
                                                <ul
                                                    ...
                                                    <li><input
                                                        ...
                                                        value="47201"
                                                        id="la47201"
                                                        class="js-checkEkiError js-fr-checkSingle"><label
                                                        for="la47201"><span>那覇市</span><span
                                                            class="searchitem-list-value">(3,075)</span></label></li>
                                                    <li><input
                                                        type="checkbox"
                                                        name="sc"
                                                        value="47205"
                                                        id="la47205"
                                                        class="js-checkEkiError js-fr-checkSingle"><label
                                                        for="la47205"><span>宜野湾市</span><span
                                                            class="searchitem-list-value">(822)</span></label></li>
                                                    <li><input
                                                        type="checkbox"
                                                        name="sc"
                                                        value="47207"
                                                        id="la47207"
                                                        class="js-checkEkiError js-fr-checkSingle"><label
                                                        for="la47207"><span>石垣市</span><span
                                                            class="searchitem-list-value">(8)</span></label></li>
                                                </ul>
        ...
        <div class="area_unit area_unit--border">
            <a href="javascript:void(0);" title="絞り込む"
                id="js-gotoMachiBtn" class="ui-btn--more"><span
                class="ui-btn ui-btn--more-inner squeeze_action_btn">チェックした市区郡の町名を絞り込む</span></a>
        </div>
        <form name="chintai_kensaku_FR301FB002ActionForm"
            id="js-gotoMachiForm" method="post"
            action="/jj/chintai/kensaku/FR301FB002/"></form>
        <form name="chintai_ichiran_FR301FC001ActionForm"
            id="js-shiborikomiPanel-searchBtnForm" method="post"
            action="/jj/chintai/ichiran/FR301FC001/"></form>
        <div class="searchbox">
            <a href="javascript:void(0);"
                class="ui-btn ui-btn--search btn--large js-shikugunSearchBtn">この条件で検索する</a>
        </div>
        <form name="chintai_kensaku_FR301FB001ActionForm"
    ...
    <!-- <script src="/js/inc-r-search.js"></script> -->
